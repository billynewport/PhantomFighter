...
CollChkRegs:	reg	d4/d5/a2/a3/a4/a5/a6
...
CheckQ		move.l	(a4),a4			* COL=Col->Flink!=Head ?
		...
		lea.l	DLE_hitbox(a2),a0	* Get HitBox of same

* Check Hitboxes for hit

		move.w	d4,d0
		add.w	HB_bxoff(a3),d0
		sub.w	DLE_newx(a2),d0
                sub.w	(a0)+,d0
		bmi	CheckQ

		move.w	d5,d0
		add.w	HB_byoff(a3),d0
		sub.w	DLE_newy(a2),d0
                sub.w	(a0)+,d0
		bmi	CheckQ
		...
		add.w	(a0)+,d0
		sub.w	d4,d0
                sub.w	HB_txoff(a3),d0
                bmi	CheckQ

		move.w	DLE_newy(a2),d0
		add.w	(a0),d0
		sub.w	d5,d0
                sub.w	HB_tyoff(a3),d0
                bmi	CheckQ

		move.l	a2,-(sp)		* If they hit,
